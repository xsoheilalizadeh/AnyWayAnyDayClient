...
namespace Airline
{
    ...
    {
        public CreateOrderRequest(string requestKey, string fareKey, string firstName, string lastName, string middleName, string nationality, string birthDate, string documentNumber, string documentExpireDate, Gender gender, string frequentFlyerAirline, string frequentFlyerNumber, string phoneNumber, string phoneCountry, string userName, string personalEmail)
        {
        ...
        public override string ToString()
        {
            var requestBuilder = new StringBuilder()
                ...
                .Append("&MName1=").Append(MiddleName)
                .Append("&MName1=").Append(Nationality)
